...
export const tldr = `IDM-VTON enhances image fideltiy and detail preservation in virtual try-on task, particularly in the real-world scenario.`;
...
Our experimental results show that our method outperforms previous approaches (both diffusion-based and GAN-based) in preserving garment details and generating authentic virtual try-on images, both qualitatively and quantitatively.
Furthermore, the proposed customization method demonstrates its effectiveness in a real-world scenario.`;